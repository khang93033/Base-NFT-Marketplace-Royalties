// base-nft-marketplace-royalties/scripts/security.js
const { ethers } = require("hardhat");
const fs = require("fs");

async function analyzeNFTRoyaltySecurity() {
  console.log("Analyzing security for Base NFT Marketplace with Royalties...");
  ...
  try {
    ...
    // Сохранение отчета
    const securityFileName = `nft-royalty-security-${Date.now()}.json`;
    ...
    console.log("NFT royalty security analysis completed successfully!");
